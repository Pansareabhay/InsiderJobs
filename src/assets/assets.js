...
import microsoft_logo_white from "./microsoft-logo-white.svg";
import walmart_logo from "./walmart_logo.svg";
import accenture_logo from "./accenture_logo.png";
import accenture_logo_white from "./accenture-logo-white.svg";
...
import amazon_logo_white from './amazon-logo-white.png'
import google_logo from './google.png'
import meta_logo from './meta_logo.svg'
import ibm_logo from './ibm_logo.svg'
import oracle_logo from './oracle_logo.svg'
...
import wipro_logo_white from './wipro-logo-white.svg'
import qualcomm_logo from './qualcomm_logo.svg'
...
export const companyLogos = {
    ...
    Meta: meta_logo,
    Google: google_logo,
    Qualcomm: qualcomm_logo,
    Microsoft: microsoft_logo,
    Slack: company_icon,
    Walmart: walmart_logo,
    Accenture: accenture_logo,
    ...
    TCS: tcs_logo,
    Infosys: infosys_logo,
    Wipro: wipro_logo,
};

export const companyLogosDark = {
    Amazon: amazon_logo_white,
    Microsoft: microsoft_logo_white,
    Wipro: wipro_logo_white,
    Accenture: accenture_logo_white,
};

export const getCompanyLogo = (company, fallback, theme) => {
    if (theme === "dark" && companyLogosDark[company]) {
        return companyLogosDark[company];
    }
    return companyLogos[company] || fallback || company_icon;
};
...
const jobCompanyOverrides = {
    "Network Engineer": "IBM",
    "Cloud Engineer": "Amazon",
};

const featuredCompanies = Object.entries(companyLogos)
    .filter(([name]) => name !== "Slack")
    .map(([name, image]) => ({
        name,
...
export const jobsData = jobsDataRaw.map((job, index) => {
    ...
    const company =
        overrideName && companyLogos[overrideName]
            ? {
                  name: overrideName,
                  email: `${overrideName.toLowerCase()}@demo.com`,
                  image: companyLogos[overrideName],
              }
